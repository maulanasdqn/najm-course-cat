...
export function PermissionForm({ onSubmit, isLoading, isEditMode, defaultValues }: PermissionFormProps) {
    const { register, handleSubmit, formState: { errors } } = useForm<TPermissionForm>({
